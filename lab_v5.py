...
def run_encoder(video_path, output_path, config, QP=27, LAMBDA=0.012):
                    ...
                    if config.get('dynamic_boxing') and best_mode in [4, 6, 7, 11]:
                        ...
                        for w_test in range(2, max_w + 1):
                            ...
                            if best_mode == 7:
                                ...
                                if np.mean((test_curr - cand_pred) ** 2) < 150.0: w_mult = w_test
                                else: break
                        ...
                        for h_test in range(2, max_h + 1):
                            ...
                            if best_mode == 7:
                                ...
                                if np.mean((test_curr - cand_pred) ** 2) < 150.0: h_mult = h_test
                                else: break
